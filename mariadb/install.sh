...
# optimus-installer PERMETTANT DE LANCER LE MENU EN TAPPANT "optimus-installer"
if ! grep -q "optimus-installer optimus" /home/debian/.bashrc
then
  echo "optimus-installer optimus='sudo bash /etc/optimus-installer/menu.sh'" >> /home/debian/.bashrc
fi
