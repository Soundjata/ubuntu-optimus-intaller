...
then
	...
	then
		...
		verbose apt install snapd 2> /dev/null
		verbose snap install core 2> /dev/null
		verbose snap install certbot --classic 2> /dev/null
		verbose snap set certbot trust-plugin-with-root=ok 2> /dev/null
		verbose snap install certbot-dns-ovh --classic 2> /dev/null
		verbose ln -s /snap/bin/certbot /usr/bin/certbot 2> /dev/null
